<template>
    <div class="single-content single--content">
        ...
        <div class="avivon-heading mt-30px">
            <h2 class="avivon__title">
                Najczęściej poszukiwane funkcjonalności OknoERP:
            </h2>
        </div>

        <div class="single__accordion mt-15px">

            <div class="accordion-container">

                <div class="ac accordion__content">
                    <h2 class="ac-q accordion__title-text" tabIndex="0">
                        Rozbudowana gospodarka magazynowa
                    </h2>
                    <div class="ac-a">
                ...
                <div class="ac">
                    <h2 class="ac-q accordion__title-text" tabIndex="0">
                        Automatyczna integracja systemu ERP z konfiguratorem produktu
                    </h2>
                    <div class="ac-a accordion__content">
                        <p class="accordion__content-desc">
                            Otwarty kod OknoERP zapełnia możliwości integracji z innymi systemami zewnętrznymi, zgodne z potrzebami klienta. własnym zakresie.
                            Zapewniamy również gotowe integracje:                    
                            <br>
                            WH Okna, WH Net, WH Planer
                            <br>
                            Systemy aluminiowe (Licz Okno m.in. Alicad, MB-Cad, Reynal, Sapa Designer, Yawal Constructor)
                            <br>
                            Systemu finansowo-księgowe (Enova, Optima)
                        </p>
                    </div>
                </div>
